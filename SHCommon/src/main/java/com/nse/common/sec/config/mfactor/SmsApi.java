...
/**
 * @author sanjeevkumar
 * @Project Share_Holder 12-Apr-2024 4:55:20 pm
 * @Objective:
 *
 */
public class SmsApi {
	...
	private RequestDefinition getInboundSmsMessagesDefinition(Integer limit, String applicationId, String entityId) {
		RequestDefinition.Builder builder = RequestDefinition.builder("GET", "/sms/1/inbox/reports")
				.requiresAuthentication(true).accept("application/json");
	...
	public class GetInboundSmsMessagesRequest {
		 ...
		 * Sets limit.
		 *
		 * @param limit Maximum number of messages to be returned in a response. If not
		 *              set, the latest 50 records are returned. Maximum limit value is
		 *              &#x60;1000&#x60; and you can only access messages for the last
		 *              48h. (optional)
		 ...
		 * Sets applicationId.
		 *
		 * @param applicationId Application id that the message is linked to. For more
		 *                      details, see our
		 ...
		 * Sets entityId.
		 *
		 * @param entityId Entity id that the message is linked to. For more details,
		 *                 see our
		 *                 [documentation](https://www.infobip.com/docs/cpaas-x/application-and-entity-management).
		 *                 (optional)
		 * @return GetInboundSmsMessagesRequest
		 ...
		 * @throws ApiException If the API call fails or an error occurs during the
		 *                      request or response processing.
		 */
		public SmsInboundMessageResult execute() throws ApiException {
			RequestDefinition getInboundSmsMessagesDefinition = getInboundSmsMessagesDefinition(limit, applicationId,
					entityId);
			return apiClient.execute(getInboundSmsMessagesDefinition, new TypeReference<SmsInboundMessageResult>() {
			}.getType());
		}
		...
		public okhttp3.Call executeAsync(ApiCallback<SmsInboundMessageResult> callback) {
			RequestDefinition getInboundSmsMessagesDefinition = getInboundSmsMessagesDefinition(limit, applicationId,
					entityId);
			return apiClient.executeAsync(getInboundSmsMessagesDefinition,
					new TypeReference<SmsInboundMessageResult>() {
					}.getType(), callback);
		}
	}
	...
	private RequestDefinition getOutboundSmsMessageDeliveryReportsDefinition(String bulkId, String messageId,
			Integer limit, String applicationId, String entityId) {
	...
	public class GetOutboundSmsMessageDeliveryReportsRequest {
		 ...
		 * Sets bulkId.
		 *
		 * @param bulkId Unique ID assigned to the request if messaging multiple
		 *               recipients or sending multiple messages via a single API
		 *               request. (optional)
		 ...
		 * Sets messageId.
		 *
		 * @param messageId Unique message ID for which a report is requested.
		 *                  (optional)
		 * @return GetOutboundSmsMessageDeliveryReportsRequest
		 */
		 ...
		 * Sets limit.
		 *
		 * @param limit Maximum number of delivery reports to be returned. If not set,
		 *              the latest 50 records are returned. Maximum limit value is
		 *              &#x60;1000&#x60; and you can only access reports for the last
		 *              48h. (optional, default to 50)
		 * @return GetOutboundSmsMessageDeliveryReportsRequest
		 */
		 ...
		 * Sets applicationId.
		 *
		 * @param applicationId Application id used to send the message. For more
		 *                      details, see our
		 *                      [documentation](https://www.infobip.com/docs/cpaas-x/application-and-entity-management).
		 *                      (optional)
		 * @return GetOutboundSmsMessageDeliveryReportsRequest
		 ...
		 * Sets entityId.
		 *
		 * @param entityId Entity id used to send the message. For more details, see our
		 *                 [documentation](https://www.infobip.com/docs/cpaas-x/application-and-entity-management).
		 *                 (optional)
		 * @return GetOutboundSmsMessageDeliveryReportsRequest
		 */
		...
		public SmsDeliveryResult execute() throws ApiException {
			RequestDefinition getOutboundSmsMessageDeliveryReportsDefinition = getOutboundSmsMessageDeliveryReportsDefinition(
					bulkId, messageId, limit, applicationId, entityId);
			return apiClient.execute(getOutboundSmsMessageDeliveryReportsDefinition,
					new TypeReference<SmsDeliveryResult>() {
					}.getType());
		}
		...
		public okhttp3.Call executeAsync(ApiCallback<SmsDeliveryResult> callback) {
			RequestDefinition getOutboundSmsMessageDeliveryReportsDefinition = getOutboundSmsMessageDeliveryReportsDefinition(
					bulkId, messageId, limit, applicationId, entityId);
			return apiClient.executeAsync(getOutboundSmsMessageDeliveryReportsDefinition,
					new TypeReference<SmsDeliveryResult>() {
					}.getType(), callback);
		}
	}
	 ...
	 *
	 * @return GetOutboundSmsMessageDeliveryReportsRequest
	 * @see <a href="https://www.infobip.com/docs/sms">Learn more about SMS channel
	 *      and use cases</a>
	 */
	...
	private RequestDefinition getOutboundSmsMessageLogsDefinition(String from, String to, List<String> bulkId,
			List<String> messageId, String generalStatus, OffsetDateTime sentSince, OffsetDateTime sentUntil,
			Integer limit, String mcc, String mnc, String applicationId, String entityId) {
		RequestDefinition.Builder builder = RequestDefinition.builder("GET", "/sms/1/logs").requiresAuthentication(true)
	...
	public class GetOutboundSmsMessageLogsRequest {
		 ...
		 * Sets sentSince.
		 *
		 * @param sentSince The logs will only include messages sent after this date.
		 *                  Use it together with &#x60;sentUntil&#x60; to return a time
		 *                  range or if you want to fetch more than 1000 logs allowed
		 *                  per call. Has the following format:
		 ...
		 * Sets sentUntil.
		 *
		 * @param sentUntil The logs will only include messages sent before this date.
		 *                  Use it together with &#x60;sentBefore&#x60; to return a time
		 *                  range or if you want to fetch more than 1000 logs allowed
		 *                  per call. Has the following format:
		 *                  &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;. (optional)
		 * @return GetOutboundSmsMessageLogsRequest
		 ...
		 * Sets limit.
		 *
		 * @param limit Maximum number of messages to include in logs. If not set, the
		 *              latest 50 records are returned. Maximum limit value is
		 *              &#x60;1000&#x60; and you can only access logs for the last 48h.
		 *              If you want to fetch more than 1000 logs allowed per call, use
		 *              &#x60;sentBefore&#x60; and &#x60;sentUntil&#x60; to retrieve
		 *              them in pages. (optional)
		 * @return GetOutboundSmsMessageLogsRequest
		 */
		...
		public SmsLogsResponse execute() throws ApiException {
			RequestDefinition getOutboundSmsMessageLogsDefinition = getOutboundSmsMessageLogsDefinition(from, to,
					bulkId, messageId, generalStatus, sentSince, sentUntil, limit, mcc, mnc, applicationId, entityId);
			return apiClient.execute(getOutboundSmsMessageLogsDefinition, new TypeReference<SmsLogsResponse>() {
			}.getType());
		}
		...
		public okhttp3.Call executeAsync(ApiCallback<SmsLogsResponse> callback) {
			RequestDefinition getOutboundSmsMessageLogsDefinition = getOutboundSmsMessageLogsDefinition(from, to,
					bulkId, messageId, generalStatus, sentSince, sentUntil, limit, mcc, mnc, applicationId, entityId);
			return apiClient.executeAsync(getOutboundSmsMessageLogsDefinition, new TypeReference<SmsLogsResponse>() {
			}.getType(), callback);
		}
	}
	 ...
	 * maximum of 1000 logs per call. See [message delivery
	...
	public class GetScheduledSmsMessagesRequest {
		...
		public SmsBulkResponse execute() throws ApiException {
			...
			return apiClient.execute(getScheduledSmsMessagesDefinition, new TypeReference<SmsBulkResponse>() {
			}.getType());
		}
		...
		public okhttp3.Call executeAsync(ApiCallback<SmsBulkResponse> callback) {
			RequestDefinition getScheduledSmsMessagesDefinition = getScheduledSmsMessagesDefinition(bulkId);
			return apiClient.executeAsync(getScheduledSmsMessagesDefinition, new TypeReference<SmsBulkResponse>() {
			}.getType(), callback);
		}
	}
	 ...
	 * <p>
	 * See all scheduled messages and their scheduled date and time. To schedule a
	...
	public class GetScheduledSmsMessagesStatusRequest {
		...
		public SmsBulkStatusResponse execute() throws ApiException {
			...
			return apiClient.execute(getScheduledSmsMessagesStatusDefinition,
					new TypeReference<SmsBulkStatusResponse>() {
					}.getType());
		}
		...
		public okhttp3.Call executeAsync(ApiCallback<SmsBulkStatusResponse> callback) {
			RequestDefinition getScheduledSmsMessagesStatusDefinition = getScheduledSmsMessagesStatusDefinition(bulkId);
			return apiClient.executeAsync(getScheduledSmsMessagesStatusDefinition,
					new TypeReference<SmsBulkStatusResponse>() {
					}.getType(), callback);
		}
	}
	 ...
	 * <p>
	 * See the status of scheduled messages. To schedule a message, use the
	...
	private RequestDefinition previewSmsMessageDefinition(SmsPreviewRequest smsPreviewRequest) {
		RequestDefinition.Builder builder = RequestDefinition.builder("POST", "/sms/1/preview").body(smsPreviewRequest)
				.requiresAuthentication(true).accept("application/json").contentType("application/json");
	...
	public class PreviewSmsMessageRequest {
		...
		private PreviewSmsMessageRequest(SmsPreviewRequest smsPreviewRequest) {
			this.smsPreviewRequest = Objects.requireNonNull(smsPreviewRequest,
					"The required parameter 'smsPreviewRequest' is missing.");
		}
		...
		public SmsPreviewResponse execute() throws ApiException {
			...
			return apiClient.execute(previewSmsMessageDefinition, new TypeReference<SmsPreviewResponse>() {
			}.getType());
		}
		...
		public okhttp3.Call executeAsync(ApiCallback<SmsPreviewResponse> callback) {
			RequestDefinition previewSmsMessageDefinition = previewSmsMessageDefinition(smsPreviewRequest);
			return apiClient.executeAsync(previewSmsMessageDefinition, new TypeReference<SmsPreviewResponse>() {
			}.getType(), callback);
		}
	}
	...
	private RequestDefinition rescheduleSmsMessagesDefinition(String bulkId, SmsBulkRequest smsBulkRequest) {
		RequestDefinition.Builder builder = RequestDefinition.builder("PUT", "/sms/1/bulks").body(smsBulkRequest)
				.requiresAuthentication(true).accept("application/json").contentType("application/json");
	...
	public class RescheduleSmsMessagesRequest {
		...
		private RescheduleSmsMessagesRequest(String bulkId, SmsBulkRequest smsBulkRequest) {
			this.bulkId = Objects.requireNonNull(bulkId, "The required parameter 'bulkId' is missing.");
			this.smsBulkRequest = Objects.requireNonNull(smsBulkRequest,
					"The required parameter 'smsBulkRequest' is missing.");
		}
		...
		public SmsBulkResponse execute() throws ApiException {
			...
			return apiClient.execute(rescheduleSmsMessagesDefinition, new TypeReference<SmsBulkResponse>() {
			}.getType());
		}
		...
		public okhttp3.Call executeAsync(ApiCallback<SmsBulkResponse> callback) {
			RequestDefinition rescheduleSmsMessagesDefinition = rescheduleSmsMessagesDefinition(bulkId, smsBulkRequest);
			return apiClient.executeAsync(rescheduleSmsMessagesDefinition, new TypeReference<SmsBulkResponse>() {
			}.getType(), callback);
		}
	}
	...
	private RequestDefinition sendBinarySmsMessageDefinition(SmsAdvancedBinaryRequest smsAdvancedBinaryRequest) {
		RequestDefinition.Builder builder = RequestDefinition.builder("POST", "/sms/2/binary/advanced")
				.body(smsAdvancedBinaryRequest).requiresAuthentication(true).accept("application/json")
	...
	public class SendBinarySmsMessageRequest {
		...
		private SendBinarySmsMessageRequest(SmsAdvancedBinaryRequest smsAdvancedBinaryRequest) {
			this.smsAdvancedBinaryRequest = Objects.requireNonNull(smsAdvancedBinaryRequest,
					"The required parameter 'smsAdvancedBinaryRequest' is missing.");
		}
		...
		public SmsResponse execute() throws ApiException {
			...
			return apiClient.execute(sendBinarySmsMessageDefinition, new TypeReference<SmsResponse>() {
			}.getType());
		}
		...
		public okhttp3.Call executeAsync(ApiCallback<SmsResponse> callback) {
			RequestDefinition sendBinarySmsMessageDefinition = sendBinarySmsMessageDefinition(smsAdvancedBinaryRequest);
			return apiClient.executeAsync(sendBinarySmsMessageDefinition, new TypeReference<SmsResponse>() {
			}.getType(), callback);
		}
	}
	 ...
	 * The API response will not contain the final delivery status, use [Delivery
	...
	private RequestDefinition sendSmsMessageDefinition(SmsAdvancedTextualRequest smsAdvancedTextualRequest) {
		RequestDefinition.Builder builder = RequestDefinition.builder("POST", "/sms/2/text/advanced")
				.body(smsAdvancedTextualRequest).requiresAuthentication(true).accept("application/json")
				.contentType("application/json");
	...
	public class SendSmsMessageRequest {
		...
		private SendSmsMessageRequest(SmsAdvancedTextualRequest smsAdvancedTextualRequest) {
			this.smsAdvancedTextualRequest = Objects.requireNonNull(smsAdvancedTextualRequest,
					"The required parameter 'smsAdvancedTextualRequest' is missing.");
		}
		...
		public SmsResponse execute() throws ApiException {
			...
			return apiClient.execute(sendSmsMessageDefinition, new TypeReference<SmsResponse>() {
			}.getType());
		}
		...
		public okhttp3.Call executeAsync(ApiCallback<SmsResponse> callback) {
			RequestDefinition sendSmsMessageDefinition = sendSmsMessageDefinition(smsAdvancedTextualRequest);
			return apiClient.executeAsync(sendSmsMessageDefinition, new TypeReference<SmsResponse>() {
			}.getType(), callback);
		}
	}
	 ...
	 * Send SMS message.
	 * <p>
	 * Use this endpoint to send an SMS and set up a rich set of features, such as
	 * batch sending with a single API request, scheduling, URL tracking, language
	 * and transliteration configuration, etc. The API response will not contain the
	...
	private RequestDefinition updateScheduledSmsMessagesStatusDefinition(String bulkId,
		...
		RequestDefinition.Builder builder = RequestDefinition.builder("PUT", "/sms/1/bulks/status")
				.body(smsUpdateStatusRequest).requiresAuthentication(true).accept("application/json")
				.contentType("application/json");
	...
	public class UpdateScheduledSmsMessagesStatusRequest {
		...
		private UpdateScheduledSmsMessagesStatusRequest(String bulkId, SmsUpdateStatusRequest smsUpdateStatusRequest) {
			this.bulkId = Objects.requireNonNull(bulkId, "The required parameter 'bulkId' is missing.");
			this.smsUpdateStatusRequest = Objects.requireNonNull(smsUpdateStatusRequest,
					"The required parameter 'smsUpdateStatusRequest' is missing.");
		}
		 ...
		 */
		public SmsBulkStatusResponse execute() throws ApiException {
			RequestDefinition updateScheduledSmsMessagesStatusDefinition = updateScheduledSmsMessagesStatusDefinition(
					bulkId, smsUpdateStatusRequest);
			return apiClient.execute(updateScheduledSmsMessagesStatusDefinition,
					new TypeReference<SmsBulkStatusResponse>() {
					}.getType());
		}
		...
		public okhttp3.Call executeAsync(ApiCallback<SmsBulkStatusResponse> callback) {
			RequestDefinition updateScheduledSmsMessagesStatusDefinition = updateScheduledSmsMessagesStatusDefinition(
					bulkId, smsUpdateStatusRequest);
			return apiClient.executeAsync(updateScheduledSmsMessagesStatusDefinition,
					new TypeReference<SmsBulkStatusResponse>() {
					}.getType(), callback);
		}
	}
	 ...
	 *      and use cases</a>
	 */
	public UpdateScheduledSmsMessagesStatusRequest updateScheduledSmsMessagesStatus(String bulkId,
			SmsUpdateStatusRequest smsUpdateStatusRequest) {
