...
/**
 * JPA entity class for "UserCatMstr"
 *
 * @author Telosys
 *
 */
@Entity
@Table(name="user_cat_mstr")
@JsonIgnoreProperties({"listOfUserReg","listOfUserCatGroup",
	                   "createdOn","createdBy","modifiedOn","modifiedBy","activeC"})
public class UserCatMstr implements Serializable {
    ...
    @OneToMany(mappedBy="userCatMstr")
    @JsonManagedReference
    private List<UserReg> listOfUserReg ; 
    ...
    @OneToMany(mappedBy="userCatMstr")
    @JsonManagedReference
    private List<UserCatGroup> listOfUserCatGroup ; 
    ...
    //--- GETTERS FOR LINKS
    public List<UserReg> getListOfUserReg() {
        return this.listOfUserReg;
    } 
    ...
    public List<UserCatGroup> getListOfUserCatGroup() {
        return this.listOfUserCatGroup;
    } 
